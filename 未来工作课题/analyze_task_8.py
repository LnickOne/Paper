#!/usr/bin/env python3
"""
Script to analyze task 8 from the Excel file
"""
...
try:
    ...
    def analyze_task_8():
        ...
        for idx, row in df.iterrows():
            if isinstance(row.iloc[0], (int, float)) and row.iloc[0] == 8:
                task_8_found = True
    ...
    try:
        ...
        def analyze_task_8():
            ...
            for row in sheet.iter_rows(
                ...
                if row and isinstance(row[0], (int, float)) and row[0] == 8:
                    task_8_found = True
                    print(f"序号: {row[0]}")
